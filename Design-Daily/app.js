...
const collage=a=>{
 ...
 return `<svg class="collage" viewBox="0 0 800 500" role="img" aria-label="极简几何拼贴缺省封面"><rect width="800" height="500" fill="#eeeee5"/>${shapes[n]}<path d="M70 440h660" stroke="#9ba08f"/><text x="70" y="470" fill="#656d59" font-size="12" font-weight="400" letter-spacing="2">设计日签 · 灵感拼贴</text></svg>`;
};
...
$('aboutButton').onclick=()=>showInfo('设计，每天发生。','<p>设计日签 是一份跨领域的设计资讯日报。从工业产品到交互界面，从动态影像到家具与出行，每天整理设计的新动向。</p><p>首页浏览简介，详情页阅读中文整理与设计解读，也可前往原文深入了解。日报按采集日期归档，各条资讯标注原始发布日期。</p><p>人工智能设计栏目收录人工智能工具、生成式创作与相关设计实践。动效关注交互与界面运动，动态设计关注影像、动画与视觉叙事。</p>');
...
function showListing(){activeArticle=null;$('listingPage').hidden=false;$('articlePage').hidden=true;document.title='设计日签 · 每天发现好设计'}
