...
function showListing(){activeArticle=null;$('listingPage').hidden=false;$('articlePage').hidden=true;document.title='设计博物馆 · 每天发现好设计'}
